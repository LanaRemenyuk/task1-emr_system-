...
class CustomTokenObtainPairViewTest(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create_user(username='doctor', password='password', role='doctor')
    ...
    def test_token_obtain_pair(self):
        ...
        """
        response = self.client.post(self.url, {'username': 'doctor', 'password': 'password'}, format='json')
...
class PatientListViewTest(APITestCase):
    def setUp(self):
        ...
        self.patient1 = Patient.objects.create(date_of_birth='2000-01-01', diagnoses={'diagnosis': 'flu'})
        self.patient2 = Patient.objects.create(date_of_birth='1990-05-15', diagnoses={'diagnosis': 'cold'})
    ...
    def test_patient_list_view_doctor_access(self):
        ...
        self.assertEqual(response.data[0]['diagnoses'], self.patient1.diagnoses)
        self.assertEqual(response.data[1]['diagnoses'], self.patient2.diagnoses)
    ...
    def test_patient_list_view_patient_access(self):
        ...
        """
        patient_user = CustomUser.objects.create_user(username='patient', password='password', role='patient')
    ...
    def test_patient_list_view_admin_access(self):
        ...
        """
        admin_user = CustomUser.objects.create_user(username='admin', password='password', role='admin')
